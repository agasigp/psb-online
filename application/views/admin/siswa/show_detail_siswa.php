...
//                    if ()
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <p class="form-control-static"><?= $siswa->jenis_kelamin == "L" ? "Laki-Laki" : "Perempuan" ?></p>
                </div>
            </div>
            <div class="form-group">
        ...
        <div class="tab-pane tab-pane-content fade" id="un">
            ...
            <?php foreach ($un as $value): ?>
                <div class="form-group">
                    ...
                    ?>
                    <div class="col-sm-2">
                        <p class="form-control-static"><?= $nilai . " x " . $bobot_nilai . "= " . $nilai * $bobot_nilai; ?></p>
                    </div>
                </div>
                <?php $total += $nilai * $bobot_nilai; ?>
            <?php endforeach; ?>
            <div class="form-group">
                <?= form_label('Total Nilai', null, array('class' => 'col-sm-2 control-label')) ?>
                <div class="col-sm-3">
